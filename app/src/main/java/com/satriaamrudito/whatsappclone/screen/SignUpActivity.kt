package com.satriaamrudito.whatsappclone.screen
            ...
            firebaseAuth.createUserWithEmailAndPassword(
                ...
                .addOnCompleteListener { task ->
                    if (!task.isSuccessful) {
                        ...
                        val user = User(email, phone, name, "", "Hello Guys", "", "")
